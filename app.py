...
"ถูกต้องเลย คลอโรพลาสต์ช่วยให้พืชสร้างอาหารเองได้ ทีนี้ลองคิดเรื่องโครงสร้างบ้าง ทีนี้ลองคิดเรื่องโครงสร้างบ้าง สัตว์มีกระดูกช่วยพยุงตัว แต่พืชไม่มีกระดูก แล้วอะไรในเซลล์พืชช่วยให้ลำต้นมันตั้งตรงได้หรอ",
...
"เป๊ะเลย เพราะมีผนังเซลล์ เซลล์พืชมักจะดูเป็นเหลี่ยมๆ และค่อนข้างแข็งแรง ส่วนเซลล์สัตว์จะดูมนและยืดหยุ่นมากกว่า"
]
